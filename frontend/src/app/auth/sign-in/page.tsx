  ...
  return (
    <div className="min-h-screen flex">
      ...
      <AuthLottie
        ...
        title="Welcome Back!"
        subtitle="Sign in to continue tracking your lost items and helping others find theirs."
        highlights={['Quick & Easy', 'Real-time Updates', 'Secure Access']}
      />
      ...
      <div className="w-full lg:w-[40%] flex items-center justify-center bg-gradient-to-br from-gray-50 via-white to-orange-50/30 px-6 sm:px-8 lg:px-14 py-8 relative overflow-hidden">
        ...
        <div className="w-full max-w-md relative z-10 animate-fade-in-up">
          {/* Form Card */}
          <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-[0_20px_60px_-15px_rgba(0,0,0,0.08)] border border-gray-100/80 p-8 sm:p-10 space-y-7">
            {/* Header */}
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative group">
                  <div className="absolute inset-y-0 left-0 flex items-center pl-4 pointer-events-none transition-colors group-focus-within:text-orange-500">
                  ...
                  <input
                    ...
                    className={`w-full pl-12 pr-4 py-3.5 border-2 rounded-xl text-base bg-gray-50/50 transition-all duration-300 focus:outline-none focus:bg-white focus:ring-4 focus:ring-orange-500/10 focus:border-orange-500 focus:shadow-sm hover:border-gray-300 ${errors.email ? 'border-red-300 bg-red-50/30 focus:ring-red-500/10 focus:border-red-500' : 'border-gray-200'}`}
                  />
                </div>
                {errors.email && (
              ...
              <div className="space-y-1.5">
                <div className="flex items-center justify-between">
                  ...
                  <Link
                    ...
                    className="text-xs text-orange-600 hover:text-orange-700 font-semibold transition-colors hover:underline underline-offset-2"
                  >
                    Forgot Password?
                  </Link>
                </div>
                <div className="relative group">
                  <input
                    ...
                    className={`w-full pl-4 pr-12 py-3.5 border-2 rounded-xl text-base bg-gray-50/50 transition-all duration-300 focus:outline-none focus:bg-white focus:ring-4 focus:ring-orange-500/10 focus:border-orange-500 focus:shadow-sm hover:border-gray-300 ${errors.password ? 'border-red-300 bg-red-50/30 focus:ring-red-500/10 focus:border-red-500' : 'border-gray-200'}`}
                  />
                  <button
                    type="button"
            ...
            <p className="text-center text-sm text-gray-600">
              ...
              <Link href="/auth/sign-up" className="text-orange-600 hover:text-orange-700 font-semibold transition-all duration-200 hover:underline underline-offset-2">
                Create Account
              </Link>
            </p>
          </div>
