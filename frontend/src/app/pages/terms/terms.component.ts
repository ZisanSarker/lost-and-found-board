      ...
      <div class="container-responsive py-6 sm:py-8 lg:py-12">
        <div class="max-w-4xl mx-auto bg-white rounded-xl sm:rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-10 space-y-6 sm:space-y-8 border border-orange-100 hover:border-orange-200 transform hover:-translate-y-1">
          ...
          <div class="space-y-4 p-3 sm:p-4 rounded-lg hover:bg-orange-50 transition-all duration-200 hover:shadow-sm">
            <h2 class="text-lg sm:text-xl lg:text-2xl font-semibold text-orange-500 hover:text-orange-600 transition-colors duration-200">1. Acceptance of Terms</h2>
          ...
          <div class="space-y-4 p-3 sm:p-4 rounded-lg hover:bg-orange-50 transition-all duration-200 hover:shadow-sm">
            <h2 class="text-lg sm:text-xl lg:text-2xl font-semibold text-orange-500 hover:text-orange-600 transition-colors duration-200">2. Posting Lost or Found Items</h2>
            <p class="text-sm sm:text-base hover:text-gray-900 transition-colors duration-200 leading-relaxed">
          ...
          <div class="space-y-4 p-3 sm:p-4 rounded-lg hover:bg-orange-50 transition-all duration-200 hover:shadow-sm">
            <h2 class="text-lg sm:text-xl lg:text-2xl font-semibold text-orange-500 hover:text-orange-600 transition-colors duration-200">3. Privacy & Contact Information</h2>
            <p class="text-sm sm:text-base hover:text-gray-900 transition-colors duration-200 leading-relaxed">
          ...
          <div class="space-y-4 p-3 sm:p-4 rounded-lg hover:bg-orange-50 transition-all duration-200 hover:shadow-sm">
            <h2 class="text-lg sm:text-xl lg:text-2xl font-semibold text-orange-500 hover:text-orange-600 transition-colors duration-200">4. User Responsibility</h2>
            <p class="text-sm sm:text-base hover:text-gray-900 transition-colors duration-200 leading-relaxed">
          ...
          <div class="space-y-4 p-3 sm:p-4 rounded-lg hover:bg-orange-50 transition-all duration-200 hover:shadow-sm">
            <h2 class="text-lg sm:text-xl lg:text-2xl font-semibold text-orange-500 hover:text-orange-600 transition-colors duration-200">5. Future Changes</h2>
            <p class="text-sm sm:text-base hover:text-gray-900 transition-colors duration-200 leading-relaxed">
