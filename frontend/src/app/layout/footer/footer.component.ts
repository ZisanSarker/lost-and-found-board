      ...
      <div class="container-responsive py-6 sm:py-8 lg:py-12">
        <div class="flex flex-col lg:flex-row items-center justify-between gap-4 lg:gap-8">
          ...
          <div class="text-center lg:text-left">
            <div class="text-xl sm:text-2xl font-bold text-orange-600 mb-2">Lost & Found</div>
          ...
          <!-- Navigation Links -->
          <nav class="flex flex-wrap justify-center gap-4 sm:gap-6 lg:gap-8 text-sm sm:text-base font-medium">
        ...
        <!-- Bottom Section -->
        <div class="mt-6 lg:mt-8 pt-4 lg:pt-6 border-t border-orange-200">
          <div class="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs sm:text-sm text-orange-600">
            <p>© 2025 Lost & Found Board. All rights reserved.</p>
            
            <!-- Social Links for larger screens -->
            <div class="hidden sm:flex items-center gap-4">
              <a href="#" class="hover:text-orange-700 transition-colors duration-200">
